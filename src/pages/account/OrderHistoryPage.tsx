              ...
              <div className="overflow-x-auto">
                {isLoading ? (
                  ...
                  <Table className="whitespace-nowrap">
                    <TableHeader>
                      <TableRow>
                        <TableHead className="pr-4 text-left">Number</TableHead>
                        <TableHead className="pr-4 text-left">Date</TableHead>
                        <TableHead className="pr-4 text-left">Ship to</TableHead>
                        <TableHead className="pr-4 text-left">Total</TableHead>
                        <TableHead className="pr-4 text-left">State</TableHead>
                    ...
                    <TableBody>
                      {orders.map((order: Order) => (
                        <TableRow key={order.tokenValue}>
                          ...
                          <TableCell className="pr-4">
                            ${(order.itemsSubtotal / 100).toFixed(2)}
                          </TableCell>
                          <TableCell className="pr-4">{order.state}</TableCell>
                          <TableCell>
                            <Link
                              to={`/account/orders/${order.tokenValue}`}
                              className="border-border hover:bg-muted inline-flex items-center rounded border px-3 py-1.5 text-sm"
                            >
                              Show
                            </Link>
                          </TableCell>
