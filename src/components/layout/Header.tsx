      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap items-center">
          <div className="flex-1">
            <Link
              to="/"
              className="inline-block lg:py-2"
              style={{ width: "10rem" }}
          ...
          <div className="flex">
            ...
            <div className="relative flex-none items-center pl-2 lg:flex">
              <small className="text-muted-foreground hidden px-1 lg:block">|</small>
              <Link
                to="/cart"
                className="link-reset flex size-9 items-center gap-1"
                aria-label="cart link"
              >
                <IconShoppingBag className="text-foreground" width="1em" stroke={1.25} size={28} />
                {order && <div className="hidden md:block">${formatPrice(order.total)}</div>}
              </Link>
            </div>
          </div>
        </div>
